...
If the prompt contains a character identity profile,
treat that identity as a hard visual constraint.

The same named character must preserve:

- species or type
- body form
- major colors
- face characteristics
- hair or fur characteristics
- clothing
- important accessories
- distinctive features

Do not reinterpret the character's name as a different
person or entity.

Do not change the character's species between panels.

Do not create a different version of the main character.
